...
export function MessageList({
  ...
  return (
    <div className="flex-grow overflow-y-auto  bg-[url(/wavy-lines.svg)] rounded border border-gray-700 bg-gray-800 p-4 mb-3">
        ...
        {messages.map(
          (msg, index) =>
            ...
            (msg.role === 'user' || msg.role === 'assistant') && (
              ...
              >
                <div
                  className={`inline-block max-w-[75%] rounded-lg px-3 py-2 text-white ${roleClasses[msg.role]}`}
                >
